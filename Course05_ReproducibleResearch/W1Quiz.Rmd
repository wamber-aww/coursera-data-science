...
1. Suppose I conduct a study and publish my 􀃒ndings. Which of the following is an example
...
analyzes the data and gets the same results as I originally obtained.
  - I take my own data, analyze it again, and publish new findings�ndings.
  - An investigator at another institution conducts a study addressing a di􀃗erent
scientific question and publishes her findings.
...
important?  
  ...
  - Computing power is limited today, making it di􀃕cult to apply sophisticated statistical methods.
...
10. What is one way in which the knitr system di􀃗ers from Sweave?
